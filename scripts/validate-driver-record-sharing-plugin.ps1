...
var specs = new[]
{
  ...
  new StepSpec("Servicos de troca Create PreValidation", "cr40f_reservadeveculos", "Create", 0, "", Array.Empty<string>(), 10),
  new StepSpec("Servicos de troca Update PreValidation", "cr40f_reservadeveculos", "Update", 0, "", Array.Empty<string>(), 10),
  new StepSpec("Servicos de troca Delete PreValidation", "cr40f_reservadeveculos", "Delete", 0, "", Array.Empty<string>(), 10),
