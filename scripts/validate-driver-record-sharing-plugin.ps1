...
var specs = new[]
{
  ...
  new StepSpec("Servicos de troca Create PreValidation", "cr40f_reservadeveiculos", "Create", 0, "", Array.Empty<string>(), 10),
  new StepSpec("Servicos de troca Update PreValidation", "cr40f_reservadeveiculos", "Update", 0, "", Array.Empty<string>(), 10),
  new StepSpec("Servicos de troca Delete PreValidation", "cr40f_reservadeveiculos", "Delete", 0, "", Array.Empty<string>(), 10),
